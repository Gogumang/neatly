...
- **웹툰 칸** — 웹툰으로 만들면 장면마다 칸을 그려, 말풍선과 함께 세로로 읽게 합니다
...
- **링크 복사** — 화면에서 바로 주소를 복사합니다

![링크 복사](docs/images/copy.png)

붙여넣으면 표지 그림과 제목이 담긴 미리보기가 함께 뜹니다. 카카오톡, 슬랙, 메일 어디에 붙여도 같습니다.

![링크 미리보기](docs/images/preview.png)
